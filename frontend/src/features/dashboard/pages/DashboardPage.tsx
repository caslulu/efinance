  ...
  const renderKpiCard = (kpiKey: string, content: ReactNode) => (
    ...
    >
      ...
      {activeKpiExplanation === kpiKey && (
        <div className="pointer-events-none absolute left-1/2 top-0 z-20 w-64 -translate-x-1/2 -translate-y-full rounded-md border bg-white p-2 text-xs text-gray-700 shadow-lg">
